...
export default function BetForm() {
  ...
  const baseURL = `http://localhost:8000/api/bets/${id}/bet`;
                    ...
                    <div className="grid grid-cols-6 gap-6">
                      ...
                      <div className="col-span-12 sm:col-span-12">
                        ...
                        <select
                          ...
                          className="mt-1 block w-full py-2 text-gray-400 px-3 border border-gray-400 bg-inherit rounded-md shadow-sm  sm:text-sm"
                        >
                          <option className="text-gray-700 ">Choose team</option>
                          <option className="text-gray-700 ">{game.firstTeam}</option>
                          <option className="text-gray-700 ">{game.secondTeam}</option>
                        </select>
                      </div>
                      <div className="col-span-12 sm:col-span-12">
